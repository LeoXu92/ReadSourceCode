...
/*
 dispatch_source_set_cancel_handler与dispatch_source_set_event_handler
 功能类似，保存一下取消事件处理的上下文信息
 */
void
...
// dispatch_source_set_timer实际上调用了_dispatch_source_set_timer
void
...
/// 在这个函数里用I/O多路复用功能的select来实现定时器功能
DISPATCH_NOINLINE
static bool
